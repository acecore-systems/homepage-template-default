    ...
    <article v-if="currentArticle">
      ...
      <div class="mb-5">
        <div class="row">
          <div class="col-1">
            <a href="#">
              ...
              <template v-else>
                <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" viewBox="0 0 24 24" fill="#CCCCCC"
        ...
        <nav class="pb-5 mb-3 w-100">
          <NuxtLink v-if="previousArticle" :to="`/blog/article/${previousArticle.slug}`"
